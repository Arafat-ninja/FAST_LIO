...
public:
	...
	typedef flatted_state processModel(state &, const input &);     //计算f的函数 对应公式(3)的f   f与状态量x和输入u有关
	...
	// 在laserMapping中使用了该函数：kf.init_dyn_share(get_f, df_dx, df_dw, h_share_model, NUM_MAX_ITERATIONS, epsi); 
